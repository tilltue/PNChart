...
@property (nonatomic, assign) CGFloat defaultBlurValue;
@end
...
- (void)layoutHeaderViewForScrollViewOffset:(CGPoint)offset
{
    ...
    if (offset.y > 0)
    {
        ...
        self.bluredImageView.alpha =   1 / kDefaultHeaderFrame.size.height * (offset.y+_defaultBlurValue) * 2;
...
- (void)refreshBlurViewForNewImage
{
    ...
    screenShot = [screenShot applyBlurWithRadius:5 tintColor:[UIColor colorWithWhite:0.6 alpha:0.5] saturationDeltaFactor:1.0 maskImage:nil];
    self.bluredImageView.image = screenShot;
}

- (void)defaultBlur:(CGFloat)value
{
    self.bluredImageView.alpha =   1 / kDefaultHeaderFrame.size.height * value * 2;
    _defaultBlurValue = value;
}
